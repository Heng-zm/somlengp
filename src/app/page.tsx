...
import { Mic, FileText, Menu, Combine, Image as ImageIcon, Users, Wand2, AudioLines, MessageSquare } from 'lucide-react';
...
export default function Home() {
  ...
  const featureCards = [
    ...
    { href: '/chat-with-ai', title: t.chatWithAi, description: t.chatWithAiDescription, icon: MessageSquare, gradient: 'from-pink-400 to-rose-400' },
  ];
