...
function testTextStyling() {
  ...
  console.log('Test 5 (HTML format, all enabled):', formatAIResponse(testText, options5));
  ...
  console.log('Test 6 (HTML format, bold disabled):', formatAIResponse(testText, options6));
