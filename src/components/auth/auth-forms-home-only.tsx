          ...
          <DropdownMenuContent className="w-56" align="end" forceMount>
            <div className="flex items-center space-x-2 p-2">
              <Avatar className="h-8 w-8">
                <AvatarImage src={getPhotoURL(user) || ''} alt={getDisplayName(user) || 'User'} />
                <AvatarFallback>{getDisplayName(user)?.charAt(0) || 'U'}</AvatarFallback>
              </Avatar>
              <div className="flex flex-col space-y-1">
                <p className="text-sm font-medium">{getDisplayName(user) || 'User'}</p>
