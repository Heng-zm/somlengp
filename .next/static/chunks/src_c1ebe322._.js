...
_s1(FeaturePageLayout, "30h84riuFmHd7sYLUY7TDCyY6YQ=");
...
"[project]/src/components/shared/visitor-tracker.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        "VisitorTracker.useEffect": ()=>{
            ...
            if (!hasVisited) {
                ...
                fetch('/api/visit', {
                    ...
                    "VisitorTracker.useEffect": (response)=>response.json()
                }["VisitorTracker.useEffect"]).then({
                    "VisitorTracker.useEffect": (data)=>{
                        if (data.success) {
                ...
                }["VisitorTracker.useEffect"]).catch({
...
//# sourceMappingURL=src_c1ebe322._.js.map